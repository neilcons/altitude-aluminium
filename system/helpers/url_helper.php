...
if ( ! function_exists('site_url'))
{
	 ...
	 * @return	string
	 */
	function site_url($uri = '', $short = TRUE)
	{
		return $short ? str_replace('http://' . $_SERVER['HTTP_HOST'], '', get_instance()->config->site_url($uri, NULL)) : __site_url($uri);
	}

	function __site_url($uri = '', $protocol = NULL)
	{

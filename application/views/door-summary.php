<table style="width:700px;background:#ffffff;" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td>
                ...
                <tr>
                    <td style="padding:15px 0px 10px 0px;">
                        <table style="width:100%;font-family:Arial, Helvetica, sans-serif;font-size:23px;color:#6ebbe6;text-align:center;" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td style="padding:10px 0px;"><img src="<?=site_url('ajax/basket_image/' . $basket_id . '?' . SID) ?>" height="158" alt="" /></td>
                            </tr>
                            <tr>
                                <td>

                ...
                <tr>
                    <td>
                        <table style="width: 650px; border-bottom: 1px solid #bcbcbc; font-family: Arial, Helvetica, sans-serif;" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="padding-left:6px;"><img src="<?php echo $image_url; ?>assets/images/email/altalum.png" height="34" width="70" alt="" border="0" /></td>
                                <td>
                                    <table style="width:450px; font-family: Arial, Helvetica, sans-serif; text-align:right;" align="right" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="font-size: 35px; color: #00C0D7; font-weight: bold;">Your Sliding Door Enquiry</td>
                                        </tr>
                                        <tr>
                                            <td style="font-size: 15px; color: #656565;">Date: <?php echo Date('d/m/Y', strtotime($door->date)); ?> &nbsp; Order Ref: <?php echo str_pad($door->id, 7, '0', STR_PAD_LEFT); ?> </td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                                    ...
                                    <table style="width: 250px; background: #FFF; border: 1px solid #00C0D7; font-family: Arial, Helvetica, sans-serif; box-shadow: 0px 3px 0px #CCC;" align="left" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="padding-right: 10px;">
                                                ...
                                                <p style="padding: 0px; margin: 0px; font-size: 12px; color: #666;"><a style="text-decoration: none; font-weight: bold; color: #000;">Click here</a> to email a member of our team quoting your ref number</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td style="width: 50%;">
                                    ...
                                    <table style="width: 100%; font-size: 12px; color: #333; font-family: Arial, Helvetica, sans-serif;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 50%">Opening <?php echo ucfirst($door->opening); ?></td>
                                        </tr>
                                        <tr>
                                    ...
                                    <table style="padding-top: 10px; width: 100%; font-size: 12px; color: #333; font-family: Arial, Helvetica, sans-serif;">
                                        <tr>
                                            <td colspan="2" style="font-weight: bold; font-size: 14px; color: #333;">Frame Colour</td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%; vertical-align: top;">Internal</td>
                                            <td style="width: 50%; vertical-align: top;">
                                                <?php echo $door->internal_colour; ?> (RAL<?php echo $door->internal_colour_ral; ?>)<br />
                                                <?php echo $door->internal_colour_finish; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%; vertical-align: top;">External</td>
                                            <td style="width: 50%; vertical-align: top;">
                                                <?php echo $door->external_colour; ?> (RAL<?php echo $door->external_colour_ral; ?>)<br />
                                    ...
                                    <table style="padding-top: 10px; width: 100%; font-size: 12px; color: #333; font-family: Arial, Helvetica, sans-serif;">
                                        <tr>
                                            <td colspan="2" style="font-weight: bold; font-size: 14px; color: #333;">Hardware</td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%">Hardware Type</td>
                                            <td style="width: 50%"><?php echo $specification; ?></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%">Hardware Colour</td>
                                            <td style="width: 50%"><?php echo $external_handle_colour; ?></td>
                                        </tr>
                                    </table>
                                ...
                                <td style="width: 50%;">
                                    ...
                                    <table style="width: 100%; font-size: 12px; color: #333; font-family: Arial, Helvetica, sans-serif;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 50%"><?php echo $door->self_cleaning == 1 ? 'No' : 'Yes'; ?></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%">Tint</td>
                                            <td style="width: 50%"><?php echo $tint; ?></td>
                                        </tr>
                                        <tr>
                                            <td style="width: 50%">Energy Efficient</td>
                                            <td style="width: 50%"><?php echo $door->energy_efficient == 1 ? 'Yes' : 'No'; ?></td>
                                        </tr>
                                    </table>
                                    ...
                                    <table style="padding-top: 10px; width: 100%; font-size: 12px; color: #333; font-family: Arial, Helvetica, sans-serif;">
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 50%"><?php echo $door->trickle_vent == 1 ? 'Yes' : 'No'; ?></td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <table style="width: 650px; padding: 20px; background: #00C0D7; font-family: Arial, Helvetica, sans-serif; color: #FFF;" align="center" cellpadding="0" cellspacing="0">
                            <tr style="vertical-align: bottom;">
                                ...
                                <td style="width: 50%;">
                                    ...
                                    <p style="margin: 0px; font-size: 12px; text-align: right;"><a style="text-decoration: none; color: #FFF;"><?php echo $aa_email_address; ?></a></p>
                                </td>
                            </tr>
                        </table>
                    </td>
